...
rule collect_all_iqtree_eval_trees:
    ...
    """
    input:
        eval_trees = expand(f"{full_file_path_iqtree_eval}.treefile", blmin_eval=blmin_eval_opts, blmax_eval=blmax_eval_opts, model_param_epsilon_eval=model_param_epsilon_eval_opts, lh_eps_eval=lh_eps_eval_opts, allow_missing=True)
    output:
...
rule collect_all_iqtree_eval_logs:
    ...
    """
    input:
        eval_logs = expand(f"{full_file_path_iqtree_eval}.iqtree.eval.log", blmin_eval=blmin_eval_opts, blmax_eval=blmax_eval_opts, model_param_epsilon_eval=model_param_epsilon_eval_opts, lh_eps_eval=lh_eps_eval_opts, allow_missing=True)
    output:
